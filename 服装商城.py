...
print("销售总金额：￥ 198400.6")
print("羽绒服的销售占比（件数）	12.96%")
print("牛仔裤的销售占比（件数）	28.04%")
print("风衣的销售占比（件数）	15.84%")
print("皮草的销售占比（件数）	11.23%")
print("T恤的销售占比（件数）	25.43%")
print("衬衫的销售占比（件数）	6.51%")

print("羽绒服的销售额占比	30.55%")
print("牛仔裤的销售额占比	22.49%")
print("风衣的销售额占比	14.25%")
print("皮草的销售额占比	14.18%")
print("T恤的销售额占比	  15.55%")
print("衬衫的销售额占比	2.98%")